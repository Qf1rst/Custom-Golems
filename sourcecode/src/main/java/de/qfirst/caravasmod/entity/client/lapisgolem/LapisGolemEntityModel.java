...
import de.qfirst.caravasmod.entity.custom.LapisGolemEntity;
...
public class LapisGolemEntityModel<T extends LapisGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public LapisGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public LapisGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T lapisGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T lapisGolemEntity, float f, float g, float h) {
        int i = lapisGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = lapisGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
