...
import de.qfirst.caravasmod.entity.custom.TNTGolemEntity;
...
public class TNTGolemEntityModel<T extends TNTGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public TNTGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public TNTGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T tntGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T tntGolemEntity, float f, float g, float h) {
        int i = tntGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = tntGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
