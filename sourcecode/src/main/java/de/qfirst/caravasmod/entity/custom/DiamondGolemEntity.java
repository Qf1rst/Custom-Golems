...
public class DiamondGolemEntity extends TameableEntity implements Angerable {
    ...
    public DiamondGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.DIAMOND_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.DIAMOND_ORE.getDefaultState();
