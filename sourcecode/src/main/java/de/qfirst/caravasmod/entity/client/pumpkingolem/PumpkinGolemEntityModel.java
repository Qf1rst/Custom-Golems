...
import de.qfirst.caravasmod.entity.custom.PumpkinGolemEntity;
...
public class PumpkinGolemEntityModel<T extends PumpkinGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public PumpkinGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public PumpkinGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T pumpkinGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T pumpkinGolemEntity, float f, float g, float h) {
        int i = pumpkinGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = pumpkinGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
