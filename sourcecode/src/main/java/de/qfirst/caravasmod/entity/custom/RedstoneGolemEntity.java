...
public class RedstoneGolemEntity extends TameableEntity implements Angerable {
    ...
    public RedstoneGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.REDSTONE_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.REDSTONE_BLOCK.getDefaultState();
