...
public class RainbowGolemEntityModel<T extends RainbowGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public RainbowGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public RainbowGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T rainbowGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T rainbowGolemEntity, float f, float g, float h) {
        int i = rainbowGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = rainbowGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
