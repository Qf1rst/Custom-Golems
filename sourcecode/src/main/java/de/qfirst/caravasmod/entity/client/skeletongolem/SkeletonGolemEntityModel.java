...
import de.qfirst.caravasmod.entity.custom.SkeletonGolemEntity;
...
public class SkeletonGolemEntityModel<T extends SkeletonGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public SkeletonGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public SkeletonGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T skeletonGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T skeletonGolemEntity, float f, float g, float h) {
        int i = skeletonGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = skeletonGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
