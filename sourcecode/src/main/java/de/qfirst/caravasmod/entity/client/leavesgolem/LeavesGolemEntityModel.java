...
import de.qfirst.caravasmod.entity.custom.LeavesGolemEntity;
...
public class LeavesGolemEntityModel<T extends LeavesGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public LeavesGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public LeavesGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T leavesGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T leavesGolemEntity, float f, float g, float h) {
        int i = leavesGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = leavesGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
