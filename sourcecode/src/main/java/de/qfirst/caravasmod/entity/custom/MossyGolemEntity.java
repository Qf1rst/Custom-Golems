...
public class MossyGolemEntity extends TameableEntity implements Angerable {
    ...
    public MossyGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.MOSS_BLOCK || item == Items.MOSSY_COBBLESTONE) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.MOSS_BLOCK) || (itemStack.getItem() == Items.MOSSY_COBBLESTONE)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.MOSS_BLOCK.getDefaultState();
            switch (num){
                case 0: bs = Blocks.MOSS_BLOCK.getDefaultState(); break;
                case 1: bs = Blocks.MOSSY_COBBLESTONE.getDefaultState(); break;
            }
