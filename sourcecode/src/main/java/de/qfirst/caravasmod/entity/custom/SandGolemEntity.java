...
public class SandGolemEntity extends TameableEntity implements Angerable {
    ...
    public SandGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.SANDSTONE || item == Items.RED_SANDSTONE) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.SANDSTONE) || (itemStack.getItem() == Items.RED_SANDSTONE)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.SAND.getDefaultState();
            switch (num){
                case 0: bs = Blocks.SAND.getDefaultState(); break;
                case 1: bs = Blocks.GRAVEL.getDefaultState(); break;
            }
