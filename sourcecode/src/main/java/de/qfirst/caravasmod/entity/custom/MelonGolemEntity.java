...
import de.qfirst.caravasmod.goals.ThrowMelonBlockGoal;
...
public class MelonGolemEntity extends TameableEntity implements Angerable {
    ...
    public MelonGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new ThrowMelonBlockGoal(this));
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.MELON_STEM.getDefaultState();
