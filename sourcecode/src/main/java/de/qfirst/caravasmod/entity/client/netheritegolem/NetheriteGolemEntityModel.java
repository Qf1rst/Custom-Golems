...
import de.qfirst.caravasmod.entity.custom.NetheriteGolemEntity;
...
public class NetheriteGolemEntityModel<T extends NetheriteGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public NetheriteGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public NetheriteGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T netheriteGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T netheriteGolemEntity, float f, float g, float h) {
        int i = netheriteGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = netheriteGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
