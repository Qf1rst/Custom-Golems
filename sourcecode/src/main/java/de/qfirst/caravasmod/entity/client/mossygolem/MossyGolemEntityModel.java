...
import de.qfirst.caravasmod.entity.custom.MossyGolemEntity;
...
public class MossyGolemEntityModel<T extends MossyGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public MossyGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public MossyGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T mossyGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T mossyGolemEntity, float f, float g, float h) {
        int i = mossyGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = mossyGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
