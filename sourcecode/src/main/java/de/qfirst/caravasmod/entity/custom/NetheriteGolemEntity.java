...
public class NetheriteGolemEntity extends TameableEntity implements Angerable {
    ...
    public NetheriteGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.ANCIENT_DEBRIS || item == Items.NETHERITE_BLOCK) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.ANCIENT_DEBRIS) || (itemStack.getItem() == Items.NETHERITE_BLOCK)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.ANCIENT_DEBRIS.getDefaultState();
