...
public class SnowGolemEntity extends TameableEntity implements Angerable {
    ...
    public SnowGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.SNOW_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.SNOW.getDefaultState();
