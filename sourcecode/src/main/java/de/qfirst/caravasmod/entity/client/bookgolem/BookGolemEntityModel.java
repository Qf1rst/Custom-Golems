...
public class BookGolemEntityModel<T extends BookGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public BookGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public BookGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T bookGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T bookGolemEntity, float f, float g, float h) {
        int i = bookGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = bookGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
