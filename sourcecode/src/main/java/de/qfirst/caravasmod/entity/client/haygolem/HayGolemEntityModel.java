...
public class HayGolemEntityModel<T extends HayGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public HayGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public HayGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T hayGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T hayGolemEntity, float f, float g, float h) {
        int i = hayGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = hayGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
