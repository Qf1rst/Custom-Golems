...
import de.qfirst.caravasmod.entity.custom.StoneGolemEntity;
...
public class StoneGolemEntityModel<T extends StoneGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public StoneGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T stoneGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T stoneGolemEntity, float f, float g, float h) {
        int i = stoneGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = stoneGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
