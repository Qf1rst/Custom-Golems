...
public class EmeraldGolemEntity extends TameableEntity implements Angerable {
    ...
    public EmeraldGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.EMERALD_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.EMERALD_ORE.getDefaultState();
