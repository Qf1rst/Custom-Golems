...
public class CrimsonGolemEntityModel<T extends CrimsonGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public CrimsonGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public CrimsonGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T crimsonGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T crimsongolementity, float f, float g, float h) {
        int i = crimsongolementity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = crimsongolementity.getLookingAtVillagerTicks();
            if (j > 0) {
