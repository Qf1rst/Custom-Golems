...
public class SkeletonGolemEntity extends TameableEntity implements Angerable {
    ...
    public SkeletonGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.BONE_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (this.age % 200 == 0) {
            ArrowEntity arrow = new ArrowEntity(this.world, this.getX(), this.getY(), this.getZ());
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.BONE_BLOCK.getDefaultState();
