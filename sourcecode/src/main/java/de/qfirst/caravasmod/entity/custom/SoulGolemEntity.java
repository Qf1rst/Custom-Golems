...
public class SoulGolemEntity extends TameableEntity implements Angerable {
    ...
    public SoulGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.SOUL_SAND || item == Items.SOUL_SOIL) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.SOUL_SAND) || (itemStack.getItem() == Items.SOUL_SOIL)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.SOUL_SAND.getDefaultState();
            ...
            ((ServerWorld) this.getEntityWorld()).spawnParticles(
                    ParticleTypes.SOUL_FIRE_FLAME, x, y, z, 1, 0.0D, 0.0D, 0.0D, 0.0D
            );
        }
    }
