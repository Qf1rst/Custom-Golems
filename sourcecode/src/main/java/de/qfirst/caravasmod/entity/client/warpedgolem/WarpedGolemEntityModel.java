...
import de.qfirst.caravasmod.entity.custom.WarpedGolemEntity;
...
public class WarpedGolemEntityModel<T extends WarpedGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public WarpedGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public WarpedGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T warpedGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T warpedGolemEntity, float f, float g, float h) {
        int i = warpedGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = warpedGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
