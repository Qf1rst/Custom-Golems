...
import de.qfirst.caravasmod.entity.custom.SoulGolemEntity;
...
public class SoulGolemEntityModel<T extends SoulGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public SoulGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public SoulGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T soulGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T soulGolemEntity, float f, float g, float h) {
        int i = soulGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = soulGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
