...
public class LeavesGolemEntity extends TameableEntity implements Angerable {
    ...
    public LeavesGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.OAK_LEAVES || item == Items.SPRUCE_LEAVES ||
                ...
                item == Items.FLOWERING_AZALEA_LEAVES) && !isTamed()) {
        ...
        if(itemStack.getItem() == Items.OAK_LEAVES || itemStack.getItem() == Items.SPRUCE_LEAVES ||
                itemStack.getItem() == Items.BIRCH_LEAVES || itemStack.getItem() == Items.JUNGLE_LEAVES ||
                itemStack.getItem() == Items.ACACIA_LEAVES || itemStack.getItem() == Items.DARK_OAK_LEAVES ||
                itemStack.getItem() == Items.MANGROVE_LEAVES || itemStack.getItem() == Items.AZALEA_LEAVES ||
                itemStack.getItem() == Items.FLOWERING_AZALEA_LEAVES){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            switch (num){
                case 0: bs = Blocks.SPRUCE_LEAVES.getDefaultState(); break;
                case 1: bs = Blocks.OAK_LEAVES.getDefaultState(); break;
                case 2: bs = Blocks.BIRCH_LEAVES.getDefaultState(); break;
                case 3: bs = Blocks.DARK_OAK_LEAVES.getDefaultState(); break;
                case 4: bs = Blocks.ACACIA_LEAVES.getDefaultState(); break;
                case 5: bs = Blocks.JUNGLE_LEAVES.getDefaultState(); break;
            }
