...
public class EmeraldGolemEntityModel<T extends EmeraldGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public EmeraldGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public EmeraldGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T ermeraldGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T emeraldGolemEntity, float f, float g, float h) {
        int i = emeraldGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = emeraldGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
