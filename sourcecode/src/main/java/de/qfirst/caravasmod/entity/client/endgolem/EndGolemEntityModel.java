...
public class EndGolemEntityModel<T extends EndGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public EndGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public EndGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T endGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T endGolemEntity, float f, float g, float h) {
        int i = endGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = endGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
