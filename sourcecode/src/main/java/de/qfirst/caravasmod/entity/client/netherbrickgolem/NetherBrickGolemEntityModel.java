...
import de.qfirst.caravasmod.entity.custom.NetherBrickGolemEntity;
...
public class NetherBrickGolemEntityModel<T extends NetherBrickGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public NetherBrickGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public NetherBrickGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T netherBrickGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T netherBrickGolemEntity, float f, float g, float h) {
        int i = netherBrickGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = netherBrickGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
