...
public class GoldenGolemEntityModel<T extends GoldenGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public GoldenGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public GoldenGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T goldenGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T goldenGolemEntity, float f, float g, float h) {
        int i = goldenGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = goldenGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
