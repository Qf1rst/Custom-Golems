...
public class EndGolemEntity extends TameableEntity implements Angerable {
    ...
    public EndGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.END_STONE;
