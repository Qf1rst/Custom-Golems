...
public class CoalGolemEntityModel<T extends CoalGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public CoalGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public CoalGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T coalGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T coalGolemEntity, float f, float g, float h) {
        int i = coalGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = coalGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
