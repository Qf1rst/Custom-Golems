...
import de.qfirst.caravasmod.entity.custom.WoodenGolemEntity;
...
public class WoodenGolemEntityModel<T extends WoodenGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public WoodenGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public WoodenGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T woodenGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T woodenGolemEntity, float f, float g, float h) {
        int i = woodenGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = woodenGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
