...
public class HayGolemEntity extends TameableEntity implements Angerable {
    ...
    public HayGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.HAY_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.HAY_BLOCK.getDefaultState();
        ...
        if (this.age % 200 == 0) {
            ItemStack wheat = new ItemStack(Items.WHEAT);
                ItemEntity itemEntity = new ItemEntity(this.world, this.getX(), this.getY(), this.getZ(), wheat);
