...
import de.qfirst.caravasmod.entity.custom.SlimeGolemEntity;
...
public class SlimeGolemEntityModel<T extends SlimeGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public SlimeGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public SlimeGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T slimeGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T slimeGolemEntity, float f, float g, float h) {
        int i = slimeGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = slimeGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
