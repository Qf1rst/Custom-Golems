...
public class TNTGolemEntity extends TameableEntity implements Angerable {
    ...
    public TNTGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
