...
public class AmethystGolemEntity extends TameableEntity implements Angerable {
    ...
    public AmethystGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.AMETHYST_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.SMALL_AMETHYST_BUD.getDefaultState();
            ...
            if (this.world.getBlockState(blockPos2).isAir() && this.world.getBlockState(blockPos3).isFullCube(world, blockPos3)) {
