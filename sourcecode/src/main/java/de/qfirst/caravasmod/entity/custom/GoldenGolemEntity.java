...
public class GoldenGolemEntity extends TameableEntity implements Angerable {
    ...
    public GoldenGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.GOLD_ORE.getDefaultState();
