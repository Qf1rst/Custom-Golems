...
public class WarpedGolemEntity extends TameableEntity implements Angerable {
    ...
    private List<EndermanEntity> spawnedEndermen = new ArrayList<>();

    public WarpedGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new MeleeAttackGoal(this, 1.0D, true) {
            ...
            public boolean canStart() {
                if (this.mob.getTarget() != null && spawnedEndermen.contains(this.mob.getTarget())) {
                    return false;
                }
        ...
        this.targetSelector.add(3, new ActiveTargetGoal<>(this, MobEntity.class, 5, false, false,
                (entity) -> entity instanceof Monster && !(entity instanceof CreeperEntity) && !spawnedEndermen.contains(entity)
        ));
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.WARPED_STEM || item == Items.WARPED_PLANKS ||
                item == Items.WARPED_WART_BLOCK) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.WARPED_PLANKS) || (itemStack.getItem() == Items.WARPED_STEM) ||
                (itemStack.getItem() == Items.WARPED_WART_BLOCK)){
    ...
    public void tickMovement() {
        ...
        if (this.age % 200 == 0) {
            ...
            enderman.setPos(this.getX(), this.getY() + 2, this.getZ());
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.WARPED_NYLIUM.getDefaultState();
