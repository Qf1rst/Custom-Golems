...
public class PumpkinGolemEntity extends TameableEntity implements Angerable {
    ...
    public PumpkinGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.PUMPKIN || item == Items.CARVED_PUMPKIN ||
                item == Items.JACK_O_LANTERN) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.PUMPKIN) || (itemStack.getItem() == Items.CARVED_PUMPKIN) ||
                (itemStack.getItem() == Items.JACK_O_LANTERN)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.PUMPKIN_STEM.getDefaultState();
