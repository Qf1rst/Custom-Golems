...
import de.qfirst.caravasmod.entity.custom.SnowGolemEntity;
...
public class SnowGolemEntityModel<T extends SnowGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public SnowGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T snowGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T snowGolemEntity, float f, float g, float h) {
        int i = snowGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = snowGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
