...
import de.qfirst.caravasmod.entity.custom.ObsidianGolemEntity;
...
public class ObsidianGolemEntityModel<T extends ObsidianGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public ObsidianGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public ObsidianGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void animateModel(T obsidianGolemEntity, float f, float g, float h) {
        ...
        if (i > 0) {
            ...
            int j = obsidianGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
