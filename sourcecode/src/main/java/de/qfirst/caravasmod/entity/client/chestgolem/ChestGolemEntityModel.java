...
public class ChestGolemEntityModel<T extends ChestGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public ChestGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public ChestGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T chestGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T chestGolemEntity, float f, float g, float h) {
        int i = chestGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = chestGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
