...
public class DeepslateGolemEntity extends TameableEntity implements Angerable {
    ...
    public DeepslateGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.DEEPSLATE || item == Items.COBBLED_DEEPSLATE) && !isTamed()) {
        ...
        if((itemStack.getItem() ==Items.DEEPSLATE) || (itemStack.getItem() == Items.COBBLED_DEEPSLATE)){
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            switch (num){
                case 0: bs = Blocks.DEEPSLATE.getDefaultState(); break;
                case 1: bs = Blocks.COBBLED_DEEPSLATE.getDefaultState(); break;
            }
