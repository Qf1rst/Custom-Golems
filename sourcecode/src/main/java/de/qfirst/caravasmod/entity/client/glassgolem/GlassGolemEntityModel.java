...
public class GlassGolemEntityModel<T extends GlassGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public GlassGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public GlassGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T glassGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T glassGolemEntity, float f, float g, float h) {
        int i = glassGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = glassGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
