...
public class DirtGolemEntityModel<T extends DirtGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public DirtGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public DirtGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T dirtGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T dirtGolemEntity, float f, float g, float h) {
        int i = dirtGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = dirtGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
