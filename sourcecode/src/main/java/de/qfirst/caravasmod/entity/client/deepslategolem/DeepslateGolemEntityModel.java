...
public class DeepslateGolemEntityModel<T extends DeepslateGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public DeepslateGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public DeepslateGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T deepslateGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T deepslateGolemEntity, float f, float g, float h) {
        int i = deepslateGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = deepslateGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
