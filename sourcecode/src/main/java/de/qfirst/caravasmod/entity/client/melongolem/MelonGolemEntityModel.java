...
public class MelonGolemEntityModel<T extends MelonGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public MelonGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public MelonGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T melonGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T melonGolemEntity, float f, float g, float h) {
        int i = melonGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = melonGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
