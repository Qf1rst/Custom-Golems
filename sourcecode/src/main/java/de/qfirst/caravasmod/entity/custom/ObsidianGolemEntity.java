...
public class ObsidianGolemEntity extends TameableEntity implements Angerable {
    ...
    public ObsidianGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.OBSIDIAN || item == Items.CRYING_OBSIDIAN) && !isTamed()) {
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.OBSIDIAN.getDefaultState();
