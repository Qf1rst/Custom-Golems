...
public class BookGolemEntity extends TameableEntity implements Angerable {
    ...
    public BookGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.BOOKSHELF;
    ...
    public void tickMovement() {
        ...
        if (this.age % 400 == 0) {
            ...
            if (!enchantments.isEmpty()) {
                ...
                EnchantedBookItem.addEnchantment(book, new EnchantmentLevelEntry(randomEnchantment, level));
                ItemEntity itemEntity = new ItemEntity(this.world, this.getX(), this.getY(), this.getZ(), book);
