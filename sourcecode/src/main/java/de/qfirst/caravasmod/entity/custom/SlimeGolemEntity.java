...
public class SlimeGolemEntity extends TameableEntity implements Angerable {
    ...
    public SlimeGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.SLIME_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            BlockState bs = Blocks.SLIME_BLOCK.getDefaultState();
