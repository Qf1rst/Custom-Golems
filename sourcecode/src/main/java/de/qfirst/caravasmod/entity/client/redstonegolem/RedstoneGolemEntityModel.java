...
import de.qfirst.caravasmod.entity.custom.RedstoneGolemEntity;
...
public class RedstoneGolemEntityModel<T extends RedstoneGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public RedstoneGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public RedstoneGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T redstoneGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T redstoneGolemEntity, float f, float g, float h) {
        int i = redstoneGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = redstoneGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
