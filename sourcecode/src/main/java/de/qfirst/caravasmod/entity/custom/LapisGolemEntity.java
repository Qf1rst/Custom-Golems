...
public class LapisGolemEntity extends TameableEntity implements Angerable {
    ...
    private int enchantmentCooldown = 0;

    public LapisGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = Items.LAPIS_BLOCK;
    ...
    public void tickMovement() {
        ...
        if (this.enchantmentCooldown > 0) {
            ...
            for (ItemEntity item : this.world.getEntitiesByClass(ItemEntity.class, this.getBoundingBox(), entity -> true)) {
                ItemStack stack = item.getStack();
                List<EnchantmentLevelEntry> enchantments = EnchantmentHelper.generateEnchantments(this.random, stack, 30, true);
                if (!enchantments.isEmpty()) {
                    EnchantmentLevelEntry enchantment = enchantments.get(0);
                    stack.addEnchantment(enchantment.enchantment, enchantment.level);
                    this.enchantmentCooldown = 10;
                }
            }
        }
    }
