...
import de.qfirst.caravasmod.entity.custom.LampGolemEntity;
...
public class LampGolemEntityModel<T extends LampGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public LampGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public LampGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T lampGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T lampGolemEntity, float f, float g, float h) {
        int i = lampGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = lampGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
