...
public class ChestGolemEntity extends TameableEntity implements Angerable {
    ...
    public ChestGolemEntity(EntityType<? extends TameableEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if ((item == Items.CHEST || item == Items.BARREL ||
                item == Items.TRAPPED_CHEST) && !isTamed()) {
        ...
        if(isTamed() && !this.world.isClient() && hand == Hand.MAIN_HAND){
            player.openHandledScreen(new SimpleNamedScreenHandlerFactory((i, playerInventory, playerEntity) -> {
                return GenericContainerScreenHandler.createGeneric9x3(i, playerInventory, this.inventory);
            }, this.getDisplayName()));
            return ActionResult.success(this.world.isClient);
        }
        if((itemStack.getItem() ==Items.CHEST) || (itemStack.getItem() == Items.BARREL) ||
