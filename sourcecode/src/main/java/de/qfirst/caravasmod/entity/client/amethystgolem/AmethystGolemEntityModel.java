...
public class AmethystGolemEntityModel<T extends AmethystGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public AmethystGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public AmethystGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T amethystGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T amethystGolemEntity, float f, float g, float h) {
        int i = amethystGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = amethystGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
