...
import de.qfirst.caravasmod.entity.custom.MagmaGolemEntity;
...
public class MagmaGolemEntityModel<T extends MagmaGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public MagmaGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public MagmaGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T magmaGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T magmaGolemEntity, float f, float g, float h) {
        int i = magmaGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = magmaGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
