...
import de.qfirst.caravasmod.entity.custom.SandGolemEntity;
...
public class SandGolemEntityModel<T extends SandGolemEntity> extends SinglePartEntityModel<T> {
    ...
    public SandGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public SandGolemEntityModel(ModelPart root, ModelPart head, ModelPart rightArm, ModelPart leftArm, ModelPart rightLeg, ModelPart leftLeg) {
        this.root = root;
        this.head = head;
    ...
    public void setAngles(T sandGolemEntity, float f, float g, float h, float i, float j) {
    ...
    public void animateModel(T sandGolemEntity, float f, float g, float h) {
        int i = sandGolemEntity.getAttackTicksLeft();
        if (i > 0) {
            ...
            int j = sandGolemEntity.getLookingAtVillagerTicks();
            if (j > 0) {
