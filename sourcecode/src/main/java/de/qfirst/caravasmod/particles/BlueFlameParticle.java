...
public class BlueFlameParticle extends AbstractSlowingParticle{
    ...
    public static class SmallFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            BlueFlameParticle blueFlameParticle = new BlueFlameParticle(clientWorld, d, e, f, g, h, i);
            blueFlameParticle.setSprite(this.spriteProvider);
            blueFlameParticle.scale(0.5F);
            return blueFlameParticle;
        }
    }
