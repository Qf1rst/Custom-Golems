...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    DEEPSLATE("deepslate", 40, new int[]{2, 5, 7, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.DEEPSLATE});
    }),
    MAGMA("magma", 20, new int[]{2, 5, 7, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 3.0F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.MAGMA_BLOCK});
    }),
    SNOW("snow", 15, new int[]{2, 5, 7, 1}, 10, SoundEvents.BLOCK_SNOW_PLACE, 2.0F, 0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.SNOW_BLOCK});
    }),
    OBSIDIAN("obsidian", 80, new int[]{2, 5, 15, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5.0F, 0.5F, () -> {
